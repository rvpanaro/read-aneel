...
Os indicadores selecionados são de natureza numérica e mede distintos aspectos das distribuidoras, provenientes da combinação de outros atributos. No entanto, além de valores inteiros ou reais, na maioria das variáveis listadas encontra-se células com caracteres, o que evidencia outra inconsistência na base de dados. Variáveis qualitativos foram imputados em campos de natureza quantitativa levando em consideraçoã situaõçes adversas inerente ao cálculo dos indicadores, no Apêndice B segue a interpretação dada aos valores usados segundo o Glossário da página 27 da 5ª Edição do Relatório.
